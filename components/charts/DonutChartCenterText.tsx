...
const data: Item[] = [
  ...
  { name: "Improvement", value: 121 },
  { name: "Improvement", value: 231 },
  { name: "Improvement", value: 123 },
  { name: "Improvement", value: 123 },
  { name: "Improvement", value: 123 },
  { name: "Improvement", value: 112 },
];

export default function DonutChartCenterText() {
  const radius = 500; // Chart base dimensions
  ...
  const colors = ["#7e4cfe", "#895cfc", "#956bff", "#a37fff", "#b291fd", "#b597ff", "#b591ff"]; // add more colors if needed
    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className={`text-4xl transition-colors duration-300 font-bold`}>0</p>
        </div>
      </div>
      <svg
