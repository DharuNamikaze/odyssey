...
const companyLogos = [
  // ... (logo definitions remain exactly the same)
  <g key={0}>
  ...
  <g key={2}>
    <path fill="#432780" d="M0 0h18v18H0V0Z" />
    <path
      fill="#F6F8FD"
  ...
  <g key={5}>
    <g className="group is-published">
      <path fill="#F0F3FA" d="M0 0h18v18H0V0Z" />
      <path fill="#50C800" d="M0 0h18v18H0V0Z" />
      <path
        fill="#8EE000"
      ...
      >
        {data.map((entry, i) => (
          <div
            ...
            className="rounded-full overflow-hidden size-6 text-sm text-gray-700"
          >
            {/* Render the logo SVG */}
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" className="">
              {companyLogos[i % companyLogos.length]} {/* Cycle through logos */}
            </svg>
          </div>
        ))}
      </div>
